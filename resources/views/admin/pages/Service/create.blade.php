                                    ...
                                    <div class="form-vertical__item bg-style">
                                        <form enctype="multipart/form-data" method="POST" action="{{route('admin.Service.store')}}">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="en_Service_name" name="en_Service_name" value="{{ old('en_Service_name') }}" placeholder="Name (English)">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label>{{ __('Service Name '.langString('fr'))}}</label>
                                                <input type="text" id="fr_Service_name" name="fr_Service_name"  value="{{ old('fr_Service_name') }}" placeholder="Name (Arabic)">
                                            </div>
                                            <div class="input__group mb-25">
