...
class FooterTableSeeder extends Seeder
{
    ...
    public function run()
    {
        FooterInformation::create([
            ...
            'Email'=>' <p class="contact">Email: support@Elegent Pet Cares.com</p>',
            ...
            'Design_Developed'=>'<p class="copyright-text">Designed And Developed By Team <a class="brand-name" href="#">Elegent Pet Care</a> Digital Agency @2021</p>'
        ]);
    }
}
