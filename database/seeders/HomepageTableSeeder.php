...
class HomepageTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Homepage::create([
            ...
            'en_Title' => 'About Us',
            'en_Description_One' => 'The Story Of Borning <br /> Company Elegent Pet Care',
        ...
        Homepage::create([
            ...
            'en_Description_One' => 'Image Gallery To Elegent Pet Care For Making Better Online Shopping Experience',
            'fr_Title' => "معرض الصور",
